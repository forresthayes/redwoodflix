      ...
      <table className="table-auto w-full min-w-3xl text-sm">
        <thead>
          <tr className="bg-gray-300 text-gray-700">
            ...
            <th className="font-semibold text-left p-3">released_on</th>
            ...
            <th className="font-semibold text-left p-3">duration</th>
            <th className="font-semibold text-left p-3">image_file_name</th>
        ...
        <tbody>
          {movies.map((movie) => (
            ...
            >
              ...
              <td className="p-3">{truncate(movie.description)}</td>
              <td className="p-3">{timeTag(movie.released_on)}</td>
              <td className="p-3">{truncate(movie.rating)}</td>
              <td className="p-3">{truncate(movie.total_gross)}</td>
              <td className="p-3">{truncate(movie.director)}</td>
              <td className="p-3">{truncate(movie.duration)}</td>
              <td className="p-3">{truncate(movie.image_file_name)}</td>
